    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        @if ($showingConfirmation)
                            {{ __('لإنهاء تمكين المصادقة الثنائية، قم بمسح رمز الاستجابة السريعة التالي باستخدام تطبيق المصادقة الخاص بهاتفك أو أدخل مفتاح الإعداد وقم بتوفير رمز OTP الذي تم إنشاؤه.') }}
                        @else
                            {{ __('تم الآن تمكين المصادقة الثنائية. قم بمسح رمز الاستجابة السريعة التالي باستخدام تطبيق المصادقة الخاص بهاتفك أو أدخل مفتاح الإعداد.') }}
                        @endif
                    </p>
                </div>
            ...
            @if ($showingRecoveryCodes)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('قم بتخزين رموز الاسترداد هذه في مدير كلمات مرور آمن. يمكن استخدامها لاستعادة الوصول إلى حسابك في حالة فقدان جهاز المصادقة الثنائية الخاص بك.') }}
                    </p>
                </div>
